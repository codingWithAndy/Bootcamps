...
import time
import pygame
current_path = os.getcwd() + "/Section 6 - Angry Birds Game/"
import pymunk as pm
...
redbird = pygame.image.load(current_path+"resources/images/red-bird3.png").convert_alpha()
background2 = pygame.image.load(current_path+"/resources/images/background3.png").convert_alpha()
sling_image = pygame.image.load(current_path+"/resources/images/sling-3.png").convert_alpha()
full_sprite = pygame.image.load(current_path+"/resources/images/full-sprite.png").convert_alpha()
...
pig_happy = pygame.image.load(current_path+"/resources/images/pig_failed.png").convert_alpha()
